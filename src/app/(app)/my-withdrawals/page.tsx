...
export default function MyWithdrawalsPage() {
  ...
  return (
    <div className="container mx-auto p-4 md:p-8 flex justify-center bg-gray-900 min-h-screen text-white">
      <Card className="w-full max-w-2xl shadow-lg bg-[#324254] border-[#94949c]">
        <CardHeader>
